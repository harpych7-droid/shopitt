/**
 * ISO 3166 country list (compact form). Used by the Country & Region picker.
 * Includes name, ISO-2 code, dialing code and an emoji flag.
 */
...
export const COUNTRIES: Country[] = [
  ...
  { code: "VA", name: "Vatican City", dial: "+39-06", flag: "🇻🇦" },
