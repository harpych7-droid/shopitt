  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.5s var(--ease-smooth, ease-out) both",
        "scale-in": "scale-in 0.3s var(--ease-smooth, ease-out) both",
        "pulse-soft": "pulse-soft 2.4s ease-in-out infinite",
        "breathe": "breathe 3s ease-in-out infinite",
        "shimmer": "shimmer 2s linear infinite",
        "glow-pulse": "glow-pulse 3s ease-in-out infinite",
        "heart-burst": "heart-burst 0.6s var(--ease-smooth, ease-out)",
      },
    },
  },
